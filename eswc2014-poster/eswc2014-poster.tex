...
\author{Ghislain A. Atemezing\inst{1}, Ahmad Assaf\inst{1}, Rapha\"{e}l Troncy\inst{1} and Elena Cabrio\inst{1,2} }

\institute{EURECOM, Sophia Antipolis, France. \email{<first.last@eurecom.fr>}
...
\paragraph{\textbf{User survey.}}%\label{sec:survey}
...
\\
\end{tabular}
\caption{Agreement on properties between the surveyed users and GKG Panel.}
\label{tab:agreement}
}
\end{table}\normalsize
...
This work has been partially supported by the Datalift Project (\#ANR-10-CORD-009) and the ANR-11-LABX-0031-01 Program.%by the French National Research Agency (ANR), within
